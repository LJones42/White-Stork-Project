...
Questions with multiple choice columns (e.g., Diet, habitat and nesting habitat - see the full questions below). For these questions respondents had the oppertunity to provide multiple answers (e.g., Diet =  fish/ carrion) and able to also select don't know. For these columns I am using the following code to inspect the data and remove any 'don't know' answers where a respondent has also selected any other choice/answer.

...
# Set likert levels
likert_att_levels <- c("Group","Item","Strongly disagree","Disagree","Neutral",
...
# Likert plot
plot(likert_positive, type="bar", text.size = 4) # include.histogram = TRUE)
...
# Plot the data
positions <- c("Nest monitoring","Nesting platform", 
                   "Tracking","Public engagement","Stork relocation","Supplementary food",
               "Damage compensation","Discourage nests","Culling","Nest removal",
                 "Not needed","Other","Don't know")
ggplot(Q17_management_summary, aes(x = reorder(Management_options, Percent), y = Percent, fill = WSP_support)) +
  geom_bar(position="stack", stat="identity") +
